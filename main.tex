...
\vincentrmk{
  L'approche devrait etre mieux précisée : 1) pour compenser
  l'absence de  donnees, Lucine  a créé/crée une  base de  donnees et
...
pour combiner deep learning et systeme expert: 1) define a set of if-then-else rules from the human
  experts, 2) train deep networks for the conditions}
